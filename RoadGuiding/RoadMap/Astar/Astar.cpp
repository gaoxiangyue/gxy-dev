...
void Astar::InitAstar(std::vector<Point*> &_points)
{
   points=_points;
}
...
{
    for (auto &p:points)//..................................
        if(p->ID==startPoint.ID||(p->x==startPoint.x&&p->y==startPoint.y))
        {
            openList.push_back(p); //置入起点
            break;
        }
...
{
    if (//target->x<bounds.minlon || target->x>bounds.maxlon
        //|| target->y<bounds.minlat && target->y>bounds.maxlat
...
std::vector<Point *> Astar::getSurroundPoints(const Point *point, bool isIgnoreCorner) const
{
    ...
    for (auto &p : point->surroundPoints)
