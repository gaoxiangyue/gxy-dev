...
MySwitch::MySwitch(QWidget *parent): QWidget(parent)
{
    checked = false;
    ...
    textColorOff = QColor(10, 20, 20);
    textColorOn = QColor(10, 10, 10);

    textOff = "OFF";
    textOn = "ON";

    imageOff = ":/res/swithch_off1.png";
    imageOn = ":/res/swithch_on1.png";
...
void MySwitch::mousePressEvent(QMouseEvent *)
{
    checked = !checked;
...
void MySwitch::resizeEvent(QResizeEvent *)
{
    //每次移动的步长为宽度的 50分之一
    step = width() / 15;
...
void MySwitch::drawBg(QPainter *painter)
{
    painter->save();
...
void MySwitch::drawSlider(QPainter *painter)
{
    painter->save();
    painter->setPen(Qt::NoPen);
...
void MySwitch::drawText(QPainter *painter)
{
    painter->save();
...
void MySwitch::drawImage(QPainter *painter)
{
    painter->save();
...
void MySwitch::setChecked(bool checked)
{
...
void MySwitch::setButtonStyle(MySwitch::ButtonStyle buttonStyle)
{
    this->buttonStyle = buttonStyle;
    update();
}

void MySwitch::setBgColor(QColor bgColorOff, QColor bgColorOn)
{
...
void MySwitch::setSliderColor(QColor sliderColorOff, QColor sliderColorOn)
{
...
void MySwitch::setTextColor(QColor textColorOff, QColor textColorOn)
{
...
void MySwitch::setText(QString textOff, QString textOn)
{
...
void MySwitch::setImage(QString imageOff, QString imageOn)
{
...
void MySwitch::setSpace(int space)
{
    this->space = space;
    update();
}

void MySwitch::setRectRadius(int rectRadius)
{
