...
: QWidget(pParent)
{
    ...
    ip_part1_->setGeometry(QRect(0, 5, WIDTH, HEIGHT));
    ip_part2_->setGeometry(QRect(WIDTH, 5, WIDTH, HEIGHT));
    ip_part3_->setGeometry(QRect(2*WIDTH, 5, WIDTH, HEIGHT));
    ip_part4_->setGeometry(QRect(3*WIDTH, 5, WIDTH, HEIGHT));

    labeldot1_->setText(".");
    labeldot1_->setGeometry(QRect(WIDTH-WIDTH/10, 5, WIDTH/10, HEIGHT));
    labeldot1_->setAlignment(Qt::AlignCenter);

    labeldot2_->setText(".");
    labeldot2_->setGeometry(QRect(2*WIDTH-WIDTH/10, 5, WIDTH/10, HEIGHT));
    labeldot2_->setAlignment(Qt::AlignCenter);

    labeldot3_->setText(".");
    labeldot3_->setGeometry(QRect(3*WIDTH-WIDTH/10, 5, WIDTH/10, HEIGHT));
